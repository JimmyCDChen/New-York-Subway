...
describe('TrainLineService', () => {
    ...
    describe('createTrain should success', () => {
        it('should create train and stations', async () => {
            ...
            await service.createTrain("E", ["Spring", "West 4th", "14th", "23rd"], 1.0);
            expect(trainLineRepoSpy).toHaveBeenCalledWith("E", ["Spring", "West 4th", "14th", "23rd"], 1.0);
